...
{
    const int btnW = 240, btnH = 56, gap = 40;
    const int count = 3;
    ...
    for (;;) {
        ...
        outtextxy(winW / 2 - 80, winH / 4 - 40, "飞机大战");
